...
router.put('/:noteId', (req, res) => {
  ...
  const note = db.prepare('SELECT n.* FROM founder_notes n JOIN founders f ON n.founder_id = f.id WHERE n.id = ? AND f.created_by = ?').get(req.params.noteId, req.user.id);
