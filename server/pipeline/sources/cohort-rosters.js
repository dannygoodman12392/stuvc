...
const PROGRAMS = [
  ...
  { key: 'a16z_speedrun', label: 'a16z Speedrun', emits: 'a16z_speedrun', cohortLabel: 'a16z Speedrun',
    markers: ['a16z speedrun', 'speedrun (a16z)', 'andreessen speedrun'],
    baseQueries: ['"a16z Speedrun" founder startup', 'a16z speedrun cohort founder'] },
